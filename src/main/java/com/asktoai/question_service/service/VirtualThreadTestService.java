...
@Service
@Slf4j
public class VirtualThreadTestService {


    public Answer getAnswerFromDelayedVirtualThread() throws ExecutionException, InterruptedException {

        var answer = supplyAnswerFromAI();
    ...
    /**
     * This method is used to fetch the answer from delayed virtual thread using CompletableFuture with supplyAsync.
     ...
     * Asagidaki method'da (fetchAnswerFromAIWithBasicCompletableFuture) sadece simple CompletableFuture kullanilarak verilmistir.
     *
     * @return CompletableFuture<Answer>
     */
    public CompletableFuture<Answer> supplyAnswerFromAI() {
        ...
        return CompletableFuture.supplyAsync(() -> {
                    ...
                    return new Answer("Here is your answer to your question");
                }, executor)
                .exceptionally(ex -> {
    ...
    public CompletableFuture<Answer> fetchAnswerFromAIWithBasicCompletableFuture(String question) {
        ...
        Thread.ofVirtual()
                ...
                .start(() -> {
                    log.info("Getting answer from Gemini");
                    CommonUtils.sleep(Duration.ofSeconds(2));
                    answer.complete(new Answer( "Here is your answer to your question"));
                });
